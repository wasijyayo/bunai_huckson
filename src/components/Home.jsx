      ...
      <Flex alignItems="center" justify="center" p={5}>
        <Card size={{ base: "sm", md: "lg" }}>
          ...
          <CardBody>
              ...
              <ModalContent>
                ...
                <ModalBody>
                  ...
                  <Button
                    ...
                    mr={3}
                    onClick={async () => {
                      editLearning.date = calculateCalories(
                        editLearning.title,
                        weight,
                        editLearning.time
                      );
            ...
            <Box p={5}>
              <div>合計運動時間：{calculatedTotalTime}</div>
            </Box>
            <Box p={25}>
              <Stack spacing={3}>
                <Button
            ...
            <Box px={25} mb={4}>
              <Stack spacing={3}>
                <Button width="100%" variant="outline" onClick={logout}>
                  ログアウト
                </Button>
              </Stack>
            </Box>
